import { c as createKeyStorage, l as loadSettings, P as PROVIDER_PRESETS, s as saveSettings, M as MSG, e as exportSettings, p as parseImportedSettings, a as PROVIDER_KEY_HELP, T as TONES, B as BEHAVIORS } from './key-storage-BRtVc9A1.js';
...
function OptionsPage() {
  ...
  const [keyStored, setKeyStored] = reactExports.useState(false);
  const [showKey, setShowKey] = reactExports.useState(false);
  const [saveBanner, setSaveBanner] = reactExports.useState(null);
  const [keyBanner, setKeyBanner] = reactExports.useState(null);
  const [testBanner, setTestBanner] = reactExports.useState(null);
  ...
  const patchProvider = reactExports.useCallback(
    (patch) => {
      setSettings((prev) => {
        if (!prev) return prev;
        ...
        const providers = prev.providers.some(
          ...
          (p) => p.providerId === active.providerId ? updated : p
  ...
  const applyPreset = reactExports.useCallback(
    async (presetId) => {
      ...
      setSettings((prev) => {
        if (!prev) return prev;
        const existing2 = prev.providers.find(
        ...
        ) ? prev.providers : [...prev.providers, next];
  ...
  const patchSettings = reactExports.useCallback((patch) => {
    setSettings((prev) => prev ? { ...prev, ...patch } : prev);
  }, []);
  const onSaveAll = reactExports.useCallback(async () => {
    if (!settings) return;
    await saveSettings(settings);
    setSaveBanner({ kind: "ok", text: "Settings saved." });
    setTimeout(() => setSaveBanner(null), 2500);
  }, [settings]);
  const onSaveKey = reactExports.useCallback(async () => {
    ...
    setKeyBanner({
      kind: "ok",
      text: settings.sessionOnlyKey ? "Key stored for this browser session only." : "Key saved locally on this device."
    });
  }, [apiKey, provider, settings]);
  const onDeleteKey = reactExports.useCallback(async () => {
    if (!provider) return;
  ...
  const onTestConnection = reactExports.useCallback(async () => {
    if (!provider) return;
    setTesting(true);
    setTestBanner(null);
    try {
  ...
  const onExport = reactExports.useCallback(() => {
    if (!settings) return;
  ...
  const onImport = reactExports.useCallback(async (file) => {
  ...
  if (!settings || !provider) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page", children: "Loading…" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "brand-row", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "WorldWrite" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "tagline", children: "Write in your language. Be understood anywhere." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "subtitle", children: "An inline communication assistant for writing, translating, and understanding messages across languages. Use your own AI — your text is processed only by the provider you configure below." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card what-you-can-do", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "What you can do" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "capabilities", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Translate" }),
          " what you write into another language."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Polish" }),
          " your writing to sound natural and fluent."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Make it professional" }),
          " for work and formal messages."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Custom rewrite" }),
          " with your own instruction."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Understand & translate" }),
          " messages you receive — for reading only, nothing on the page changes."
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card getting-started", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Getting started — 3 steps" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { className: "steps", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          "Set your ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Native language" }),
          " (your first language) and your ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Target writing language" }),
          " below."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          "Pick an ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "AI provider" }),
          ", get a free/paid API key from its website, paste it, and click ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Save key" }),
          ". Use",
          " ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          "On any web page, select text, ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "right-click" }),
          " →",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "WorldWrite" }),
          ", and pick an action. You will always see a preview before anything is replaced."
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Languages" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "native", children: "Native language" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "native",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "target", children: "Target writing language" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "target",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "preset", children: "Provider preset" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            id: "preset",
            value: PROVIDER_PRESETS.some((p) => p.providerId === provider.providerId) ? provider.providerId : "",
            onChange: (e) => void applyPreset(e.target.value),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Custom" }),
              PROVIDER_PRESETS.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: p.providerId, disabled: !p.enabled, children: [
                p.displayName,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hint", children: "OpenAI, Anthropic (Claude), Google Gemini, OpenRouter and DeepSeek are available now. More providers are coming soon." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "model", children: "Model name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "model",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hint", children: "Pick a preset above and this is filled for you. Change it only if you want a different model." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "advanced", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { children: "Advanced settings (optional)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "baseUrl", children: "API base URL" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "baseUrl",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "apiFormat", children: "API format" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              id: "apiFormat",
              value: provider.apiFormat,
              onChange: (e) => patchProvider({ apiFormat: e.target.value }),
              children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hint", children: "Use Anthropic for Claude via api.anthropic.com and Gemini for Google models. Claude/Gemini through an OpenAI-compatible gateway (e.g. OpenRouter) should stay on OpenAI-compatible." })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "API Key" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: "apiKey", children: [
          "API key for ",
          provider.displayName
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              id: "apiKey",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setShowKey((v) => !v), children: showKey ? "Hide" : "Show" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "key-state", children: keyStored ? settings.sessionOnlyKey ? "A key is stored for this browser session only." : "A key is stored locally on this device." : "No key stored yet." }),
        PROVIDER_KEY_HELP[provider.providerId] ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hint", children: [
          "Don’t have a key?",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
        ...
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hint", children: "Local providers (Ollama, LM Studio, LiteLLM) usually don’t need a key — enter any value if one is required." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "toggle", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => patchSettings({ sessionOnlyKey: e.target.checked })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "label", children: "Do not persist key" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hint", children: "Keep the key only for the current browser session (chrome.storage.session). It is cleared when the browser closes." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "primary", onClick: onSaveKey, children: "Save key" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: onTestConnection, disabled: testing, children: testing ? "Testing…" : "Test connection" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "danger", onClick: onDeleteKey, children: "Delete key" })
      ] }),
      keyBanner && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `status ${keyBanner.kind}`, children: keyBanner.text }),
      testBanner && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `status ${testBanner.kind}`, children: testBanner.text }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "key-state", children: "Your key is stored locally and sent only to the provider URL above. It is never written to logs, page content, or exported settings." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Defaults" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "tone", children: "Default tone" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              id: "tone",
              value: settings.defaultTone,
              onChange: (e) => patchSettings({ defaultTone: e.target.value }),
              children: TONES.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: t.value, children: t.label }, t.value))
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "behavior", children: "Default behavior" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              id: "behavior",
              ...
              onChange: (e) => patchSettings({
                defaultBehavior: e.target.value
              }),
              children: BEHAVIORS.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: b.value, children: b.label }, b.value))
            }
          )
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "toggle", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hint", children: "On by default. Only the text you select is sent to your provider. Nothing is stored: no selected text, no AI responses, no history, no page URL or title, no surrounding context." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "toggle", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => patchSettings({ contextAwareMode: e.target.checked })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "label", children: "Context-aware mode" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hint", children: "Allow sending limited surrounding context. Disabled while privacy mode is on." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "toggle", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => patchSettings({ saveLocalHistory: e.target.checked })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "label", children: "Save local rewrite history" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hint", children: "Store recent rewrites locally on this device only. Disabled while privacy mode is on." })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Backup" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: onExport, children: "Export settings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => importInputRef.current?.click(), children: "Import settings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ref: importInputRef,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "privacy-banner", children: "Exported files never include your API key." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky-save", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "primary", onClick: onSaveAll, children: "Save all settings" }),
      saveBanner && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `status ${saveBanner.kind}`, children: saveBanner.text })
    ] })
  ] });
}
...
if (container) {
  createRoot(container).render(
    /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(OptionsPage, {}) })
  );
}
